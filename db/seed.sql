...
-- dogs
INSERT INTO dogs (breed, dogName, age, sex, desexed, childfriendly, userText, dogImage, UserId, createdAt, updatedAt) VALUES ('Bulldog', 'Bobby', '4', 'male', '1', 'grass' , '1', 'Very calm dog', 'placeholder', '1', now(), now());
INSERT INTO dogs (breed, dogName, age, sex, desexed, childfriendly, userText, dogImage, UserId, createdAt, updatedAt) VALUES ('Chihuahua', 'Rosie', '8', 'female', '0', 'broccoli' , '1', 'Always excited', 'placeholder', '2', now(), now());
INSERT INTO dogs (breed, dogName, age, sex, desexed, childfriendly, userText, dogImage, UserId, createdAt, updatedAt) VALUES ('French Bulldog', 'Martha', '5', 'female', '1', 'none' , '1', 'Good with kids', 'placeholder', '3', now(), now());
INSERT INTO dogs (breed, dogName, age, sex, desexed, childfriendly, userText, dogImage, UserId, createdAt, updatedAt) VALUES ('Rottweiler', 'Oscar', '6', 'male', '0', 'onion' , '0', 'Not good with kids', 'placeholder', '4', now(), now());
INSERT INTO dogs (breed, dogName, age, sex, desexed, childfriendly, userText, dogImage, UserId, createdAt, updatedAt) VALUES ('Pomeranian', 'Speedy', '2', 'male', '1', 'none' , '1', 'Happy dog', 'placeholder', '5', now(), now());
INSERT INTO dogs (breed, dogName, age, sex, desexed, childfriendly, userText, dogImage, UserId, createdAt, updatedAt) VALUES ('Doberman', 'Lexi', '10', 'female', '1', 'pepper' , '1', 'not good with big dogs', 'placeholder', '6', now(), now());
INSERT INTO dogs (breed, dogName, age, sex, desexed, childfriendly, userText, dogImage, UserId, createdAt, updatedAt) VALUES ('Maltese dog', 'Dobby', '12', 'male', '0', 'grass' , '1', 'no other males please', 'placeholder', '7', now(), now());
INSERT INTO dogs (breed, dogName, age, sex, desexed, childfriendly, userText, dogImage, UserId, createdAt, updatedAt) VALUES ('Basset Hound', 'Goldie', '4', 'female', '1', 'none' , '1', 'calm dog', 'placeholder', '8', now(), now());
INSERT INTO dogs (breed, dogName, age, sex, desexed, childfriendly, userText, dogImage, UserId, createdAt, updatedAt) VALUES ('Bull Terrier', 'Bibi', '8', 'female', '0', 'grass' , '1', 'does not like water', 'placeholder', '9', now(), now());
INSERT INTO dogs (breed, dogName, age, sex, desexed, childfriendly, userText, dogImage, UserId, createdAt, updatedAt) VALUES ('Basenji', 'Oscar', '3', 'male', '1', 'sweets' , '1', 'humps everything', 'placeholder', '10', now(), now());
